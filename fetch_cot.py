...
log.info("Kombinert: %d markeder -> data/combined/latest.json", len(combined))

if do_history:
    log.info("[HISTORISKE DATA]")
    for report in REPORTS:
